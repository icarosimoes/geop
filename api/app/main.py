...
from app.domain.commercial.webhook_router import router as commercial_webhook_router
...
from app.domain.support.router import router as support_router
...
v1_router.include_router(commercial_webhook_router)
