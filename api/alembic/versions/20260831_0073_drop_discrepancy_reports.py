"""remove conferência de discrepâncias (recurso descontinuado)

Revision ID: 20260831_0073
Revises: 20260831_0072
Create Date: 2026-08-31

Feature removida do produto (menu e domínio de API) — dropa as tabelas
criadas em 20260830_0067 e as permissões associadas. downgrade() recria o
estado daquela migration (tabelas + RLS + permissões), mas sem os dados.
"""
