...
def upgrade() -> None:
    ...
    # Create new indices
    op.create_index("ix_schedule_entries_employee_date", "schedule_entries", ["company_id", "employee_id", "date"])
    ...
    # Create new index
    op.create_index("ix_time_punches_employee_date", "time_punches", ["company_id", "employee_id", "punched_at"])
...
def downgrade() -> None:
    ...
    op.create_index("ix_schedule_entries_user_date", "schedule_entries", ["company_id", "user_id", "date"])
    op.create_unique_constraint(
    ...
    op.drop_constraint("fk_time_clock_enrollments_employee_id", "time_clock_enrollments", type_="foreignkey")
    ...
    op.create_index("ix_time_punches_user_date", "time_punches", ["company_id", "user_id", "punched_at"])
